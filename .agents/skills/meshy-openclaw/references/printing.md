# Printing Pipelines (meshy-openclaw)
...
- `scripts/meshy_task.py` — Meshy API CLI (create / poll / download / record / …); see this skill's `references/pipelines.md` for general generation recipes and [../reference.md](../reference.md) for all parameters.
